...
```
usage: mdc [-h] [-o OUTPUT_FILENAME] [-r REFS_DIRNAME] [-s | -v] [-p] [-R]
           [input_filename]

Compile Markdown file(s) with extensions for hierachy, footnotes, indexed
terms and references to DOCX or PDF.
...
options:
  ...
  -o OUTPUT_FILENAME, --output_filename OUTPUT_FILENAME
                        Name of the output file. Its extension ('.docx' or
                        '.pdf') determines the format. Default: 'main.docx'.
